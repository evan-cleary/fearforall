...
public class KillStreakEngine extends Engine {
    ...
    public void runStartupChecks() throws EngineException {
        ...
        eng = FearForAll.getInstance().getEngineManger().getEngine("Inventory");
        if (eng != null) {
    ...
    public void onPlayerKillstreakRewarded(PlayerKillstreakAwardedEvent evt) {
        ...
        if (!pStorage.isRewarded(killStreak)) {
            if (killStreak == 1) {
                ...
                rewards.add(new ItemStack(Material.ROTTEN_FLESH, 32));
        ...
        rewards.add(new ItemStack(Material.ROTTEN_FLESH, 12));
    }
    ...
    public int addKill(Player killer, Player victim) {
        ...
        if (killer != null) {
            ...
            if (pStorage != null) {
                ...
                killer.sendMessage(ChatColor.YELLOW + "[FearForAll]" + ChatColor.RED + " You killed: " + victim.getName());
                victim.sendMessage(ChatColor.YELLOW + "[FearForAll]" + ChatColor.RED + " You were killed by: " + killer.getName());
